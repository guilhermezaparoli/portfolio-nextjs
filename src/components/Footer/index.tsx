...
export function Footer() {
  return (
    <div className="flex flex-col items-center justify-center gap-8 font-DM_Sans text-sm">
      <h1 className="text-simple text-3xl font-bold dark:text-white">
        Conecte-se comigo
      </h1>
      ...
      <button className="px- border-simple text-simple rounded-lg border-2 p-3 text-center font-itensMenu text-xs font-bold dark:border-white dark:text-white">
        Vamos conversar
      </button>

      <div className="text-simple font-poppins text-xs dark:text-white">
